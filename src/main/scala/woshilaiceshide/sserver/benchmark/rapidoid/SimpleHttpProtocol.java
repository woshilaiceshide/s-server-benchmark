...
public class SimpleHttpProtocol implements Protocol {
	...
	private static final byte[] URI_PLAIN = "/ping".getBytes();
	...
	public void process(Channel channel) {
		...
		response(channel, buf, path, isGet.value, isKeepAlive.value);
	}

	private void response(Channel ctx, Buf buf, BufRange path, boolean isGet, boolean isKeepAlive) {
